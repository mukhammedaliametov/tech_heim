...
const Footer = () => {
    return (
        <>
        <div className='max-w-[1224px] mx-auto px-[16px] xl:px-0 flex items-center gap-[40px] xl:gap-0 justify-between mt-[50px] overflow-x-scroll xl:overflow-x-visible'>
        ...
        <div className='bg-[#021736] h-auto md:h-[287px] mt-[25px]'>
            <div className='max-w-[1224px] mx-auto px-[16px] xl:px-0 gap-[20px] text-white py-[30px] flex flex-col md:flex-row items-start items-center justify-between'>
            ...
            <div className='max-w-[1224px] mx-auto px-[16px] xl:px-0 text-gray-400 pt-[20px] pb-[20px] xl:pb-0 border-t border-gray-400 flex items-start items-center justify-between'>
                <p>&copy;2023 Tech Heim.</p>
                <div className='hidden md:flex gap-[30px] capitalize'>
